...
exports.builder = (yargs) => {
    yargs
        ...
        .example(`$0 bake ./python2.yml`, `Treat a local .yml file as the baker.yml and Bake it`)
    ...
    yargs.positional('source', {
        describe: `where the baker.yml comes from: a directory, a local .yml file, owner/repo, or a URL. Omit to use ./baker.yml.`,
        type: 'string'
    });
...
exports.handler = async function(argv) {
    const { source, local, repo, file, box, remote, remote_key, remote_user, verbose, forceVirtualBox, useContainer, useVM  } = argv;
