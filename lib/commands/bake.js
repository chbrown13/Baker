...
exports.builder = (yargs) => {
    yargs
        ...
        .example(`$0 bake --gist https://gist.github.com/username/1234567890abcdef`, `Clone a GitHub Gist containing baker.yml and Bake it`);
    ...
    yargs.options(
        {
            ...
            gist: {
                alias: 'g',
                describe: `give a GitHub gist URL which consists of a baker.yml file`,
                demand: false,
                type: 'string'
            },
            box: {
...
exports.handler = async function(argv) {
    const { local, repo, gist, box, remote, remote_key, remote_user, verbose, forceVirtualBox, useContainer, useVM  } = argv;
    ...
    try{
        ...
        if( box ){
            ...
            bakePath = path.resolve(await Git.cloneGist(gist));
        } 
        else if (remote) {
