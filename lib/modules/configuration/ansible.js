...
class Ansible {
    ...
    static async runRemoteAptInstall(doc, cmd, remoteSSHConfig, verbose) {
        return Ansible.runRemoteAdhoc(doc, 'apt', `pkg=${cmd} update_cache=yes cache_valid_time=86400`, remoteSSHConfig, verbose);
    }
    ...
    static async runDockerAptInstall(doc, cmd, containerName, verbose) {
        return Ansible.runDockerAdhoc(doc, 'apt', `pkg=${cmd} update_cache=yes cache_valid_time=86400`, containerName, verbose);
    }
